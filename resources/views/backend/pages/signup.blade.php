                  ...
                  <form action="/admin/signup" method="POST">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input value="{{old('name')}}" type="text" class="form-control input-lg" id="name" name="name" aria-describedby="nameHelp" placeholder="Name">
                        @error('name')
                      ...
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" name="email" value="{{old('email')}}" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Email">
                        @error('email')
